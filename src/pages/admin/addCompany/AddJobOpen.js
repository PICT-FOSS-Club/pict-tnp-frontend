...
const AddJobOpen = () => {
  ...
  const [drive, setDrive] = useState([
    { roundNo: "", activity: "", venue: "", date: "", time: "" },
  ]);
  ...
  const handleSubmit = async (e) => {
    ...
    if (!jobFile) {
      await axios
        .post(
          "http://localhost:8080/company/job/add",
          { data: company },
          {
      ...
      alert("Job Description File is not selected!");
    }
  };
  return (
    <div id="adminCOmpanyTable">
      <div className="col-md-6 col-sm-6 cl-sx-6 col-6">
        <h3>{state.companyName} - Add new job opening</h3>
      </div>
                    ...
                    <div className="form-check form-switch">
                      <input
                        ...
                        onChange={() => {
                          setAddcriteria({
                            ...addcriteria,
                            attendance: !addcriteria.attendance,
                          });
                          var attendinput =
                            document.getElementById("attendinput");
                    ...
                    <div className="form-check form-switch">
                      <input
                        ...
                        onChange={() => {
                          setAddcriteria({
                            ...addcriteria,
                            amcat: !addcriteria.amcat,
                          });
                          var amcatinput =
                            document.getElementById("amcatinput");
                  ...
                  return (
                    <div key={i}>
                      ...
                      <div className="btn-box my-1 col-md-4">
                        {drive.length !== 1 && (
                          <button
                            onClick={() => handleRoundRemoveClick(i)}
