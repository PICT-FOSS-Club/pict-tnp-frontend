        ...
        return (
           ...
           <div className="col-md-12">
            ...
            <div className="btn-box my-1 col-md-4">
              {JDinputList.length !== 1 && <button
                onClick={() => handleRemoveClick(i)} className="btn btn-danger my-2 mx-1">Remove</button>}
              {JDinputList.length - 1 === i && <button onClick={handleAddClick} className="btn btn-primary my-2 mx-1">Add</button>}
            </div>
        </div>
        );
      })}
